/* @ds-bundle: {"format":4,"namespace":"AkoreLabsDesignSystem_192c69","components":[{"name":"Logo","sourcePath":"components/brand/Logo.jsx"},{"name":"Badge","sourcePath":"components/core/Badge.jsx"},{"name":"Button","sourcePath":"components/core/Button.jsx"},{"name":"Card","sourcePath":"components/core/Card.jsx"},{"name":"Eyebrow","sourcePath":"components/core/Eyebrow.jsx"},{"name":"Icon","sourcePath":"components/core/Icon.jsx"},{"name":"Input","sourcePath":"components/core/Input.jsx"},{"name":"Stat","sourcePath":"components/core/Stat.jsx"}],"sourceHashes":{"components/brand/Logo.jsx":"40634262520a","components/core/Badge.jsx":"552bf2fb429e","components/core/Button.jsx":"12f6b9845003","components/core/Card.jsx":"f0de8d304518","components/core/Eyebrow.jsx":"c7861597df47","components/core/Icon.jsx":"ec0b3cf053bb","components/core/Input.jsx":"ea6d7dc0db4e","components/core/Stat.jsx":"7f0a9b70e802","docs/doc-page.js":"f106e1b77ea0","slides/deck-stage.js":"918b31a1fa04"},"inlinedExternals":[],"unexposedExports":[]} */

(() => {

const __ds_ns = (window.AkoreLabsDesignSystem_192c69 = window.AkoreLabsDesignSystem_192c69 || {});
...
function Eyebrow({
  ...
  }, rest), marker === "tick" && /*#__PURE__*/React.createElement("span", {
    style: {
      width: "22px",
      height: "2px",
      background: color,
  ...
  }), marker === "dot" && /*#__PURE__*/React.createElement("span", {
    style: {
      width: "7px",
      height: "7px",
      borderRadius: "50%",
...
function Input({
  ...
  const id = useId();
  const borderColor = error ? "var(--danger)" : focus ? "var(--violet-600)" : "var(--border-default)";
...
function Stat({
  ...
  const accents = {
    ...
    ink: onDark ? "var(--white)" : "var(--ink-950)"
  };
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    ...
    style: {
      fontFamily: "var(--font-body)",
      fontSize: "var(--fs-sm)",
      color: onDark ? "var(--ink-300)" : "var(--text-body)",
      marginTop: "6px",
      maxWidth: "28ch"
    }
  }, caption));
